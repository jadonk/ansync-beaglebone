...
function AN2006(serial, alias, logger) {
    AN2006.super_.call(this,
...
util.inherits(AN2006, device.BaseDevice);

AN2006.prototype.init = function() {
    ...
    this.boardHandle = this.libvita.AN2006_new(this.portHandle, 0);
    if (this.boardHandle <= 0) {
        return new Error("Failed to bind driver to " + this.getIdentifier());
    }

    // Set all pins as output
    rc = this.libvita.AN2006_setDirections(this.boardHandle, 0x0000);
    if (rc < 0) {
        this.close();
...
AN2006.prototype.setChannel = function(channel, power) {
    var mask;
    var data;
    var rc = -1;
    ...
    mask = this.libvita.AN2006_getInputs(this.boardHandle);
    ...
    rc = this.libvita.AN2006_setOutputs(this.boardHandle, mask);
...
AN2006.prototype.getChannel = function(channel) {
    var mask;
    var rc = -1;
...
AN2006.prototype.button = function(channel, power) {
    this.setChannel(channel, power);
}

exports.AN2006 = AN2006;
